...
export function VolunteerForm() {
  ...
  return (
    <div id="volunteer" className="flex flex-col md:flex-row items-start justify-start max-w-7xl mx-auto md:px-0 px-4 overflow-hidden">
      <motion.div
        ref={ref}
      ...
      >
        <Tabs defaultValue="individual" className="w-full" onValueChange={() => reset()}>
          <TabsList className="grid w-full grid-cols-2">
            ...
            <TabsTrigger value="group" className="data-[state=active]:bg-black data-[state=active]:text-white">
              {t("group")}
            </TabsTrigger>
          </TabsList>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Select
                              ...
                              value={field.value}
                            >
                              <SelectTrigger className="w-full bg-gray-100 p-2 border border-gray-300 rounded">
                                [...]
                              </SelectTrigger>
                              <SelectContent>
                                [...]
